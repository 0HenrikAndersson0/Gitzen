...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  gitPushTags: (remote) => ipcRenderer.invoke('git:pushTags', remote),
  ...
  createTag: (tagName, commitHash, message) => ipcRenderer.invoke('git:createTag', tagName, commitHash, message),
